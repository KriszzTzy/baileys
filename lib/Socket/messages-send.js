...
return {
    ...
    sendMessage: async (jid, content, options = {}) => {
        ...
        // OTOMATIS TAMBAHKAN AI: TRUE UNTUK SEMUA PESAN
        // Cek apakah content adalah object dan bukan tipe pesan tertentu
        if (typeof content === 'object' && 
            !('album' in content) && 
            !('stickerPack' in content) &&
            ...
            // Tambahkan ai: true secara otomatis
            content.ai = true;
        }
        
        // Handler untuk kedua objek
        ...
        // Sticker pack handling dari kode pertama
        ...
        // Default message handling (gabungan dari kedua kode)
        else {
            let mediaHandle;
